...
$sql="SELECT * from codemart WHERE LessonNumber=".$no;
...
<div style="box-shadow:0px 1px 20px #888888 ; ">
	<img src="../Images/logo.jpg" style="width:88%; height:auto;margin-top:3px;margin-left:2%;padding:10px;background-color: white;">
</div>
	...
	<div style="box-shadow:0px 1px 20px grey ;padding:10px">
		<p style="margin-bottom:50px;"><a href="category.php?diff=0" style="padding-right:70px;">BEGINNER</a></p>

		<p style="margin-bottom:50px;"><a href="category.php?diff=1">INTERMEDIATE</a></p>

		<p style="margin-bottom:50px;"><a href="category.php?diff=2" style="padding-right:100px;">EXPERT</a></p>
...
<div style="margin-left:260px;">
	...
	<div style="background-color:white;padding:50px;">
		...
		<form style="margin-top:50px;margin-left:10%" name="f1" action="checking.php" method="post">
