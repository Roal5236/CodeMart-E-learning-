...
<body>
	...
	switch ($_GET['diff']) {
			case '0':
				$sql="SELECT * from codemart_c WHERE LessonNumber<=2003";
				break;

			case '1':
				$sql="SELECT * from codemart_c WHERE LessonNumber>2003 AND LessonNumber<=2006";
				break;

			case '2':
				$sql="SELECT * from codemart_c WHERE LessonNumber>2006";
				break;
			
			default:
				$sql="SELECT * from codemart_c";
				break;
		}	
	...
	if(mysqli_num_rows($query)==0) {
		...
		do {
			...
			<a href="lesson2.php?no=<?php echo $rs['LessonNumber'];?>&attempt=no">
				<p class="cat11_img">
					<VIDEO>
